<?php
echo "<h2>ksort() - Sorts by key</h2>";
echo "<p>This function sorts an array by keys in ascending order while maintaining the key-value associations.</p>";
...
echo "<input type='submit' name='ksort' value='Sort by Key'>";
echo "</form>";
...
if (isset($_POST['ksort'])) {
    ...
    // Apply ksort() function
    ksort($array);
    
    echo "<h3>Sorted Array (using ksort()):</h3>";
    echo "<pre>";
    print_r($array);
    echo "</pre>";
    
    echo "<p>Notice how the array is sorted by keys in ascending order while maintaining key-value associations.</p>";
}
?>