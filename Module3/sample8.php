<?php
echo "<h2>asort() - Sorts by value; maintains key association</h2>";
echo "<p>This function sorts an array by values in ascending order while maintaining the original key-value associations.</p>";
...
echo "<input type='submit' name='asort' value='Sort by Value (Keep Keys)'>";
echo "</form>";
...
if (isset($_POST['asort'])) {
    ...
    echo "<p>Notice how the values are sorted but the original keys are preserved.</p>";
}
?>